...
# Второй этап
## Промежуточный результат по 2 этапу
...
- реализован `CompanyDao`;
- проверена работа методов сохранения и чтения данных. <br> <br>
![Важно](https://img.shields.io/badge/UPDATE-23.03.2026-red) <br>
- DAO-метод получения списка обучающихся по курсу
- DAO-метод получения расписания преподавателя на заданный интервал времени
